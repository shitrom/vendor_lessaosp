#
# LESSAOSP Audio Files
#

ALARM_PATH := vendor/lessaosp/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lessaosp/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lessaosp/prebuilt/common/media/audio/ringtones
